...
from scraper_laserena import ejecutar_extraccion

print("🚀 INICIANDO MAIN LA SERENA")

# 1. Ejecutar scraper
data_laserena = ejecutar_extraccion()

# 2. Iniciar Spark
spark = SparkSession.builder \
    .appName("IntegradoraRealEstateLaSerena") \
    ...
    .config("spark.mongodb.output.collection", "propiedades_laserena") \
    .getOrCreate()

# 3. Convertir lista a DataFrame
df = spark.createDataFrame(data_laserena)
...
print("✅ Proceso finalizado: datos de La Serena enviados a MongoDB Atlas.")